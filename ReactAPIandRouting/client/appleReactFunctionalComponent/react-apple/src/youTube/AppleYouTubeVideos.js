...
function AppleYouTubeVideos() {
  ...
  useEffect(() => {
    fetch(
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyAIHr0uMvO8sbFlio__QLCq1nhg8o6mAM0&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=08"
    )
