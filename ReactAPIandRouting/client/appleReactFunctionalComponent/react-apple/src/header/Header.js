    ...
    <div className="nav-wrapper fixed-top">
      <div className="container">
        <nav className="navbar navbar-toggleable-sm navbar-expand-md">
          ...
          <Link className="navbar-brand mx-auto" to="logo">
          ...
          <div className="navbar-collapse collapse">
            <ul className="navbar-nav nav-justified w-100 nav-fill">
              ...
              <li className="nav-item">
                <Link className="nav-link js-scroll-trigger" to="/AirPods/">
                  AirPods
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link js-scroll-trigger" to="/Tv & Home/">
                  Tv & Home
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <Link className="nav-link js-scroll-trigger" to="Accessories">
                  Accessories
                </Link>
              </li>
              <li className="nav-item">
